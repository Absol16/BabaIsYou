...
public:
     ...
     */
    vector<std::vector<std::vector<ObjectGame>>> getBoard();
    ...
    /**
     * Method that clears all rules after winning the game.
     */
    void clearRuleAfterWin();
...
private:
    ...
    */
    void changePositionObject(const Direction &d, const Position &pos);
    /**
     ...
     */
    bool canBeMoved(const Direction &d);
     ...
     */
    bool isInsideRule(const Material& mat);
     ...
     */
    bool checkIsPush(const Position &pos, const Position &targetPos, const Direction &d);
     ...
     */
    bool killYou(Position &pos, Aspect AspectToBeChecked);
