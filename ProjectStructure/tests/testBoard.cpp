...
TEST_CASE("Test Board methods") {
    ...
    SECTION("setTabGame") {
        ...
        REQUIRE(std::equal(board.getBoard()[0][0].begin(), board.getBoard()[0][0].end(), element.begin(), element.end()));
    }
    ...
    SECTION("checkBuildRule() for ROCK"){
        ...
        ObjectGame rock2(Position(3, 3), Material::ROCK ,Enum::Aspect::NONE);
        ...
        REQUIRE(board.getBoard()[pos.getX()][pos.getY()][0].getAspectObject()==Enum::Aspect::PUSH);
    }
    ...
    SECTION("checkBuildRule() for WALL"){
        ...
        ObjectGame wall(Position(3, 3), Material::WALL ,Enum::Aspect::NONE);
        ...
        REQUIRE(board.getBoard()[pos.getX()][pos.getY()][0].getAspectObject()==Enum::Aspect::STOP);
    }
    ...
    SECTION("checkBuildRule() for BABA"){
        ...
        ObjectGame baba(Position(3, 3), Material::BABA ,Enum::Aspect::NONE);
        ...
        REQUIRE(board.getBoard()[pos.getX()][pos.getY()][0].getAspectObject()==Enum::Aspect::YOU);
    }
    ...
    SECTION("move"){
        ...
        ObjectGame you(Position(2,3), Material::BABA ,Enum::Aspect::YOU);
        ObjectGame rock1(Position(1, 3), Material::ROCK ,Enum::Aspect::PUSH);
        ObjectGame rock2(Position(3, 3), Material::ROCK ,Enum::Aspect::PUSH);
        ObjectGame wall1(Position(1,2), Material::WALL ,Enum::Aspect::STOP);
        ObjectGame wall2(Position(3,2), Material::WALL , Enum::Aspect::STOP);
        ObjectGame sink1(Position(1,1), Material::WATER ,Enum::Aspect::SINK);
        ObjectGame sink2(Position(3,1), Material::WATER ,Enum::Aspect::SINK);
        ObjectGame nothing1(Position(2,2), Material::NOTHING, Enum::Aspect::NONE);
        ObjectGame nothing2(Position(2,4), Material::NOTHING, Enum::Aspect::NONE);
        ObjectGame nothing3(Position(1,3), Material::NOTHING, Enum::Aspect::NONE);
        ObjectGame nothing4(Position(3,3), Material::NOTHING, Enum::Aspect::NONE);
        ...
        ObjectGame you2(Position(2,2), Material::BABA, Enum::Aspect::YOU);
        ObjectGame kill1(Position(2,1), Material::LAVA, Enum::Aspect::KILL);
        listObj.clear();
