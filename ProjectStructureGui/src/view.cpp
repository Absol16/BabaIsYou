...
void View::displayBoard() {
    ...
    int numRows = this->model->getBoard().getTabBoard().size();
    int numCols = this->model->getBoard().getTabBoard()[0].size();
    vector<vector<vector<ObjectGame>>> b = model->getBoard().getTabBoard();
